...
def predict(args):
    ...
    final_prediction = click_probabilities[0, 4].item()
    exam_prediction = exam_probs[0, 4].item()
    attr_prediction = attr_scores[0, 4].item()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_model', type=int, default=24529, help='Yüklenecek modelin adım numarası (checkpoint).')
    script_args = parser.parse_args()

    # 2. Modelin eğitildiği sabit (hardcoded) parametreleri bir sözlükte topla
    # Bu değerler "expB_cont_neigh10_lr_0_0005" deneyinden alınmıştır.
    model_params = {
        # --- Temel Ayarlar ---
        'dataset': 'emj',
        'model_dir': './outputs/models/expB_cont_neigh10_lr_0_0005',     
        'result_dir': './outputs/results/expB_cont_neigh10_lr_0_0005',   
        'summary_dir': './outputs/summary/expB_cont_neigh10_lr_0_0005',  
        'log_dir': './outputs/log/',
        'algo': 'GraphCM',
